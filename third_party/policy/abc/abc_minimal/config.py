...
MIXTURE_PRESETS: dict[str, list[MixtureComponent]] = {
    ...
    # YAM-ABC-Reproduce single-task, real-only mix (no sim). Produced by
    # `yam-abc-convert --to abc` -> export_mcap.py -> train_real/val_real.
    "yam_abc": [
...
MIXTURE_PRESETS["freemani"] = MIXTURE_PRESETS["yam_abc"]
...
class TrainConfig:
    ...
    mixture_preset: Literal["bottles", "yam_abc", "freemani"] = "bottles"
